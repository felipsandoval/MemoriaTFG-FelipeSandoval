...
Se creaban programas en scratch y se verificaba que estaba bien

Se ejecuta sobre el test.sb3

Se ejecuta sobre múltitud de ficheros hasta que ya no salen errores en los logs

Hablar sobre los test unitarios
